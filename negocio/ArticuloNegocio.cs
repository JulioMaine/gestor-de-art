...
namespace negocio
{
    public class ArticuloNegocio
    {
        public List<Articulo> listar()
        {
            ...
            try
            {
                datos.setearConsulta("select A.Id, Codigo, Nombre, A.Descripcion, ImagenUrl, M.Descripcion Marca, A.IdMarca, C.Descripcion Categoria, A.IdCategoria, Precio from ARTICULOS A, MARCAS M, CATEGORIAS C where A.IdMarca = M.Id and A.IdCategoria = C.Id");
